...
usage() {
  cat <<'USAGE'
Usage: scripts/tuna.sh [CONFIG_PATH]

Arguments:
  CONFIG_PATH  Path to YAML config (default: configs/tuna.yaml)

Options:
  -h, --help   Show this help message

Example:
  sbatch scripts/tuna.sh configs/tuna.yaml
  sbatch scripts/tuna.sh configs/test_tuna.yaml
USAGE
}

...
#SBATCH --output=logs/v2/slurm_%j.out
#SBATCH --error=logs/v2/slurm_%j.err
...
CONFIG_PATH="configs/v2.yaml"

usage() {
  cat <<'USAGE'
Usage: scripts/v2.sh [CONFIG_PATH]

Arguments:
  CONFIG_PATH  Path to YAML config (default: configs/v2.yaml)

Options:
  -h, --help   Show this help message

Example:
  sbatch scripts/v2.sh configs/v2.yaml
USAGE
}

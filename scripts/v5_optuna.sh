...
#SBATCH --output=logs/v5_optuna/slurm_%j.out
#SBATCH --error=logs/v5_optuna/slurm_%j.err
...
python -m src.tune.finetune_optuna --config configs/v5.yaml --checkpoint "${CHECKPOINT_PATH}" "$@"
